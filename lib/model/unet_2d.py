...
class UNet2D(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False, factor=2):
        ...
        upsample_factor = 2 if bilinear else 1
        ...
        self.down4 = (Down(512 // factor, 1024 // factor // upsample_factor))
        self.up1 = (Up(1024 // factor, 512 // factor // upsample_factor, bilinear))
        self.up2 = (Up(512 // factor, 256 // factor // upsample_factor, bilinear))
        self.up3 = (Up(256 // factor, 128 // factor // upsample_factor, bilinear))
